...
$objects = array(
	...
	"modelo"=>array(
		"table"=>"modelo inner join fabricante on modelo.id_fabricante=fabricante.id_fabricante"
		,"table1"=>"modelo"
		,"idName"=>"id_modelo"
		,"fields"=>array(
			"id_modelo"
...

{
	...
	"modelo"=>array(
		"table"=>"modelo inner join fabricante on modelo.id_fabricante=fabricante.id_fabricante where ".
		          "modelo.id_modelo = ANY (select id_modelo from maquinas where rif_principal = '". $_REQUEST["id_rif"]."')"
		,"table1"=>"modelo"
		,"idName"=>"id_modelo"
		,"fields"=>array(
			"id_modelo"
