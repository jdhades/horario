 ...
 * @version   1.0
 * @date      19. March 2008
 * @revision  $Id: Ext.ux.menu.IconMenu.js 780 2009-11-24 01:19:17Z jozo $
 * @license   
...
Ext.extend(Ext.ux.menu.IconMenu, Ext.util.Observable, {
	...
	,closeHandler:function() {
		if(this.panel.closable) {
			...
			// removed http://www.extjs.com/forum/showthread.php?p=390391
//			if('hide' !== action) {
//				this.onDestroy();
//			}
			this.panel[action]();
		...
		this.icon.on({
			...
			,dblclick:function() {
				if(this.dblClickClose) {
					...
					// next line added http://www.extjs.com/forum/showthread.php?p=390391
					this.hideMenu();
